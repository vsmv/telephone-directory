...
export default function ReportsPage() {
  ...
  useEffect(() => {
    if (!user || !isAdmin) {
      console.log('Reports page - Auth check:', { user: !!user, isAdmin });
      router.push('/dashboard');
      return;
    }
    
    console.log('Reports page - Loading data for:', reportType);
    loadReportData();
  }, [reportType, filterBy, filterValue, user, isAdmin]);
  ...
  }, [searchTerm, ideas, plans, contacts, reportType]);
