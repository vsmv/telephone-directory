...
import { Search, Filter, Download, ArrowLeft, User, Building2, Phone, Mail, MapPin, Loader2, LayoutDashboard } from "lucide-react";
...
export default function SearchPage() {
  ...
  useEffect(() => {
    ...
    console.log('🔐 Search Page - Auth Check:', { token: !!token, mockUser: !!mockUser, isLoggedIn: isAuthenticated });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex gap-3">
              {/* Show Dashboard and Back to Home buttons only for logged-in users */}
              {isLoggedIn && (
                <>
                  <Button 
                    variant="outline"
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
          <CardHeader className="bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-600 text-white flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              {searchTerm && (
                <span className="text-sm font-normal text-blue-100 ml-2 block sm:inline">
                  ...
                  {(searchTerm.includes('*') || searchTerm.includes('?')) && 
                    <span className="text-yellow-200"> (with wildcards)</span>
                  }
                </span>
              )}
            </CardTitle>
