...
import { Shield, Search, Phone, Mail, MapPin, Building, Users, FileText, Lock, Zap, CheckCircle2, Lightbulb, GraduationCap, Target, LayoutDashboard, LogOut } from "lucide-react";
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-100 rounded-full px-6 py-2 mb-6">
            ...
            <span className="text-blue-700 font-semibold">Welcome to ACTREC Directory System</span>
          </div>
