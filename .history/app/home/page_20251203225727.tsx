      ...
      <div className="py-16 px-4">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-blue-600" />
                    {userRole === 'admin' ? 'Full CRUD operations' : 'View contact details'}
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            {userRole === 'admin' ? (
              <>
                <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1">
                  <CardHeader>
                    ...
                    <CardTitle className="text-xl text-gray-900">Bulk Operations</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-700 mb-3">Manage large datasets efficiently with powerful bulk operation tools.</p>
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-center gap-2">
                ...
                <Card className="border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-purple-50 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1">
                  <CardHeader>
                  ...
                  <CardContent>
                    <p className="text-gray-700 mb-3">Control user access, roles, and permissions across the system.</p>
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li className="flex items-center gap-2">
                  ...
                  {userRole === 'admin' ? (
                    ...
                    <div className="space-y-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-900">Access Admin Dashboard</h4>
                          <p className="text-sm text-gray-600">Navigate to Dashboard to access all administrative features and controls</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Add, edit, delete contacts. Use bulk operations for CSV import/export and mass updates</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Create users, assign roles (admin/regular), reset passwords, and manage permissions</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">View system statistics, manage your password, and monitor total users and contacts</p>
                        </div>
                      </div>
                    </div>
                  ) : (
                    ...
                    <div className="space-y-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Click &ldquo;Back to Dashboard&rdquo; to access your personal workspace and features</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">2</div>
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Use Search Directory to find contacts by name, department, designation, or location</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">3</div>
                        <div>
                          <h4 className="font-semibold text-gray-900">Manage Learning Plans</h4>
                          <p className="text-sm text-gray-600">Create and track your professional development plans with categories and progress status</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0">4</div>
                        <div>
                          <h4 className="font-semibold text-gray-900">Submit Patent Ideas</h4>
                          <p className="text-sm text-gray-600">Document innovative ideas with descriptions, categories, and track their review status</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-3">
                    {userRole === 'admin' ? (
                      ...
                      [
                        ...
                        "Centralized user and contact management",
                      ...
                      [
                        "Quick access to organizational contacts",
                        "Personal learning plan tracking",
                        "Innovation idea documentation system",
