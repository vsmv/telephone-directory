            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-green-600 mb-1">Selected</p>
                      <p className="text-3xl font-bold text-green-900">{selectedContacts.length}</p>
                    </div>
              ...
              <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-purple-600 mb-1">Departments</p>
              ...
              <Card className="shadow-lg border-0">
                <CardHeader className="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-t-lg">
                  ...
                  <CardDescription className="text-indigo-100">
                    Update or delete multiple contacts at once
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className={`p-5 rounded-xl transition-all duration-300 ${
                    selectedContacts.length > 0 
                      ? 'bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-300 shadow-md' 
                      : 'bg-gray-50 border-2 border-gray-200'
                  }`}>
                    <h4 className="font-semibold mb-3 flex items-center gap-2 text-lg">
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                        selectedContacts.length > 0 ? 'bg-red-500' : 'bg-gray-400'
                      }`}>
                        <Trash2 className="w-4 h-4 text-white" />
                      </div>
                      <span className={selectedContacts.length > 0 ? 'text-red-900' : 'text-gray-700'}>
                        Bulk Delete
                      </span>
                      <span className={`ml-auto text-sm font-normal px-3 py-1 rounded-full ${
                        selectedContacts.length > 0 ? 'bg-red-200 text-red-800' : 'bg-gray-200 text-gray-600'
                      }`}>
                        {selectedContacts.length} selected
                      </span>
                    </h4>
                    {selectedContacts.length === 0 ? (
                      <p className="text-sm text-gray-500">Select contacts below to enable bulk delete</p>
                    ) : (
                      <Button 
                        variant="destructive" 
