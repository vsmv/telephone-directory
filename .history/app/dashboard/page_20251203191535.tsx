...
import { 
  ...
  User, Building2, Phone, Mail, MapPin, Loader2, Eye, EyeOff
} from "lucide-react";
        ...
        <Tabs defaultValue="contacts" className="space-y-6">
          ...
          {hasPermission('canBulkOperations') && (
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              {/* Export Data Card */}
              <Card className="shadow-xl border-0 overflow-hidden h-full flex flex-col">
                ...
                <CardContent className="pt-6 flex-1 flex flex-col">
                  <div className="space-y-4 flex-1 flex flex-col">
                    <div className="flex-1">
                      <Button onClick={exportContacts} className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-md">
                        <Download className="w-4 h-4 mr-2" />
                        Export All Contacts ({contacts.length})
                      </Button>
                    </div>
                    <div className="text-sm text-gray-600 space-y-2">
                      <p className="font-medium mb-2">Export Details:</p>
                      <p>✓ All contact fields included</p>
                      <p>✓ CSV format compatible for bulk re-upload</p>
                      <p>✓ Filename: actrec_contacts_YYYY-MM-DD.csv</p>
                      <p className="text-xs mt-2 text-gray-500">File downloads automatically to your device</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
