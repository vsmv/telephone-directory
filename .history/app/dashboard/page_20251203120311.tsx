              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className={`p-4 rounded-lg ${
                    selectedContacts.length > 0 ? 'bg-blue-50 border-2 border-blue-200' : 'bg-gray-50 border-2 border-gray-200'
                  }`}>
                    <h4 className="font-medium mb-3 flex items-center gap-2">
                      <Edit className="w-4 h-4" />
                      Bulk Update ({selectedContacts.length} selected)
                    </h4>
                  ...
                  {/* Bulk Delete Section */}
                  <div className={`p-4 rounded-lg ${
                    selectedContacts.length > 0 ? 'bg-red-50 border-2 border-red-200' : 'bg-gray-50 border-2 border-gray-200'
                  }`}>
                    <h4 className="font-medium mb-3 flex items-center gap-2">
                      <Trash2 className="w-4 h-4" />
                      Bulk Delete ({selectedContacts.length} selected)
                    </h4>
                    {selectedContacts.length === 0 ? (
