        ...
        <Tabs defaultValue="contacts" className="space-y-6">
          ...
          {hasPermission('canBulkOperations') && (
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card className="shadow-xl border-0 overflow-hidden">
                <CardHeader 
                  className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-600 text-white cursor-pointer hover:opacity-90 transition-opacity"
                ...
                <CardContent className="pt-6">
                  ...
                  <Button 
                    onClick={() => document.getElementById('csvFile')?.click()}
                    disabled={loading}
                    className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white shadow-md h-12"
                  >
              ...
              <Card className="shadow-xl border-0 overflow-hidden">
                <CardHeader 
                  className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-600 text-white cursor-pointer hover:opacity-90 transition-opacity"
