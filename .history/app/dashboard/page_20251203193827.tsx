        ...
        <Tabs defaultValue="contacts" className="space-y-6">
          ...
          {hasPermission('canBulkOperations') && (
            ...
            <div className="grid gap-6 md:grid-cols-2 auto-rows-fr">
              {/* Bulk Upload Card */}
              <Card className="shadow-xl border-0 overflow-hidden flex flex-col">
                <CardHeader className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-600 text-white">
                  <CardTitle className="flex items-center gap-2">
                ...
                <CardContent className="pt-6 flex-1 flex flex-col">
                  <div className="space-y-4 flex-1">
                    ...
                    {/* Spacer to match Export card height */}
                    {!selectedFile && !csvPreview && !uploadProgress && (
                      <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
                        <div className="flex items-center gap-2">
                          <FileText className="w-4 h-4 text-gray-400" />
                          <div className="flex-1">
                            <p className="text-sm font-medium text-gray-500">No file selected</p>
                            <p className="text-xs text-gray-400">Choose a CSV file to upload</p>
                          </div>
                        </div>
                      </div>
                    )}
              ...
              <Card className="shadow-xl border-0 overflow-hidden flex flex-col">
                ...
                <CardContent className="pt-6 flex-1 flex flex-col">
                  <div className="space-y-4 flex-1">
                    <Label htmlFor="exportBtn">Export Options</Label>
                    <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
                      <div className="flex items-center gap-2">
                        <Download className="w-4 h-4 text-emerald-600" />
                        <div className="flex-1">
                          <p className="text-sm font-medium text-emerald-900">Ready to export {contacts.length} contacts</p>
                          <p className="text-xs text-emerald-600">CSV format with all fields</p>
                        </div>
                      </div>
                    </div>
                    <Button 
